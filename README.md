...
* __Blokowanie Reklam__ - [Ublock Origin](https://github.com/gorhill/uBlock) -> [Adblock Plus](https://adblockplus.org/) -> [Disconnect](https://addons.mozilla.org/en-US/firefox/addon/disconnect/?src=search)
* __Blokowanie Wyskakujących Okien__ - [Popup-Blocker](https://addons.mozilla.org/en-US/firefox/addon/popup-blocker)
* __Blokowanie Javascript__ - [NoScript(Fi)](https://addons.mozilla.org/en-US/firefox/addon/noscript)
...
* __Menedżer Ciasteczek__ - [Cookie Quick Manager(Fi)](https://addons.mozilla.org/en-US/firefox/addon/cookie-quick-manager)
...
* __Zarządzenie Hasłami__ - [Bitwarden(Fi)](https://addons.mozilla.org/en-US/firefox/addon/bitwarden-password-manager)
